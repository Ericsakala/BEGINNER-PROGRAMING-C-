...
//
//	cout<<nnovator[i].firstName<<endl;
//	cout<<innovator[i].SurName<<endl;
//	cout<<innovator[i].age<<endl;
//	cout<<innovator[i].nrc<<endl;
//	cout<<innovator[i].Title_of_innovation<<endl;
//	cout<<innovator[i].category<<endl;
//	cout<<innovator[i].date<<endl;
//counter++;
//}
//}
void display()
...
for(int i=0;i<counter;i++){
	...
	cout<<innovator.firstName[i]<<endl;
	cout<<innovator.SurName[i]<<endl;
	cout<<innovator.age<<endl;
